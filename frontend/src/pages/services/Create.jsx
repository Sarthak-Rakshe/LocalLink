...
export default function CreateService() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        e2?.response?.data?.message || e2.message || "Failed to create service"
      );
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <h1 className="mb-4 text-2xl font-semibold">Create service</h1>
      {error && (
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        />
        <HelpText>
          Provider ID will be set automatically to your account.
        </HelpText>
